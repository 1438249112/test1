...
public class MDS2ODHDSS_Select_SQL implements IMappingSolver {
public static void main(String[] args) throws Exception {
	new MDS2ODHDSS_Select_SQL().generateSql();
}
    		...
    		for (int j = 0; j < idpFileds.size(); j++) {
    			...
    			if(idpFiled.contains("sys_last_modified")){
    				continue;
    		 		...
    		 		filedsString +=idpFiled+" "+idpFiled+ " ,";			
			}

    		String selectSql = "select  "+filedsString +" from  " + tableName ;
    		
    		System.out.println(selectSql.toLowerCase());
		}
	...
	public MDS2ODHDSS_Select_SQL() throws Exception {
