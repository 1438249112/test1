...
public class Update_MDS2ODHDSS_Common_SQL implements IMappingSolver {
public static void main(String[] args) throws Exception {
	new Update_MDS2ODHDSS_Common_SQL().generateSql();
}
	...
	public Update_MDS2ODHDSS_Common_SQL() throws Exception {
